...
const StaffCRUD = ({
  ...
  return (
    <>
      {(showLoadingOverlay || isLoading) && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-700 p-4 md:p-6 rounded-lg shadow-lg text-center max-w-xs md:max-w-sm">
            <FaSpinner className="animate-spin text-2xl md:text-3xl text-blue-500 dark:text-blue-400 mx-auto mb-3 md:mb-4" />
      ...
      {modalReady && (
        <ModalForm
          isOpen={modalState.viewStaff && modalReady}
          onClose={() => {
            setModalState((prev) => ({ ...prev, viewStaff: false }));
            setModalReady(false);
          }}
          ...
          {isLoading ? (
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-1 p-1 space-y-1">
                <div className="mt-1 bg-white dark:bg-gray-800 p-3 rounded shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-1 p-1 space-y-1">
                ...
                <div className="bg-white dark:bg-gray-800 p-3 rounded shadow-sm">
                  ...
                  <p className="text-gray-800 dark:text-gray-200 font-medium">
                    {staffData.phone ? `+${staffData.phone}` : "-"}
                  </p>
                </div>
      ...
      {modalReady && (
        <ModalForm
          isOpen={modalState.editStaff && modalReady}
          onClose={() => {
            setError("");
            setModalState((prev) => ({ ...prev, editStaff: false }));
            setModalReady(false);

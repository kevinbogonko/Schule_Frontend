...
export default function LoadingSpinner() {
  return (
    <div className="flex items-center justify-center h-screen bg-white dark:bg-gray-900 flex-col space-y-6">
      ...
      <motion.p
        ...
        className="text-gray-500 dark:text-gray-400 font-medium text-lg mt-2"
      >
